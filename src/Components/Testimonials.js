...
const Testimonials = (props) => {
    ...
    return (
        <div className='w-[75vw] md:w-[700px] bg-white flex flex-col justify-center items-center mt-10 p-10 transition-all rounded-md duration-700 hover:shadow-lg'>
            ...
            rounded-md font-bold text-white text-lg mt-5'>Surprise Me</button>
            </div>
        </div>
    )
}
